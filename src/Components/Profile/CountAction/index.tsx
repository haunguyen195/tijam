    ...
    <View style={styles.container}>
      <View style={styles.containerCount}>
        ...
        <View style={styles.viewCount}>
          <Text style={styles.textCount}>{numberHelpers(Math.floor(Math.random() * 2000000),language)}</Text>
        ...
        {/*notice*/}
        <View style={styles.viewCount}>
          <Text style={styles.textCount}>{numberHelpers(Math.floor(Math.random() * 10000000),language)}</Text>
        ...
        {/*share*/}
        <View style={styles.viewCount}>
          <Text style={styles.textCount}>{numberHelpers(Math.floor(Math.random() * 500000),language)}</Text>
